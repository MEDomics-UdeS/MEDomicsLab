...
def create_holdout_set():
    ...
    progress += progress_step
    input_progress[request_id] = {"now": progress, "currentLabel": "Creating holdout set"}
    ...
    save_dataframe(final_dataset_path+"train_"+final_name, final_dataset_extension, train_set)
    save_dataframe(final_dataset_path+"holdout_"+final_name, final_dataset_extension, holdout_set)
