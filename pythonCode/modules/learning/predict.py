...
from med_libs.mongodb_utils import connect_to_mongo, get_child_id_by_name, get_dataset_as_pd_df, \
    get_pickled_model_from_collection, insert_med_data_object_if_not_exists, overwrite_med_data_object_content
...
class GoExecScriptPredict(GoExecutionScript):
    ...
    def _custom_process(self, json_config: dict) -> dict:
        ...
        prediction_object = MEDDataObject(id=str(uuid.uuid4()),
                                          ...
                                          childrenIDs=[],
                                          inWorkspace=False)
        prediction_med_object_id = insert_med_data_object_if_not_exists(prediction_object,
