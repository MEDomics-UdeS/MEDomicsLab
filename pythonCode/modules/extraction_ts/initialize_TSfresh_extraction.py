...
class GoExecScriptInitializeTSfreshExtraction(GoExecutionScript):
    """
    ...
    def _custom_process(self, json_config: dict) -> dict:
        """
        Run intitialization of time series extraction using TSfresh library.
...
script = GoExecScriptInitializeTSfreshExtraction(json_params_dict, id_)
script.start()
