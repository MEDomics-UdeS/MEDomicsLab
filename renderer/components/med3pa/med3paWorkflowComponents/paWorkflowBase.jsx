 ...
 */
const PaWorkflowBase = ({ isGoodConnection, groupNodeHandlingDefault, onDeleteNode, onNodeDrag, mandatoryProps, ui, uiTopLeft, uiTopRight, uiTopCenter, customOnConnect }) => {
  ...
  const createBaseNode = (position, node, id) => {
    const { nodeType, name, image, description } = node
    console.log("createBaseNode:", nodeType, name, image, description)
