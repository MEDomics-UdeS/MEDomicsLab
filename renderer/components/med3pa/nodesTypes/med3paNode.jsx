          ...
          <>
            <div className="center">
              <Button variant="light" className="width-100 btn-contour">
                {data.internal.settings.target ? "Change Selected Parameters" : "Select MED3pa Parameters"}
              </Button>
            </div>
            <div className="center">
              <Button
              ...
              >
                ...
                >
                  ...
                  {showDetails ? (
                    <Icon.Dash style={{ color: hovered ? "black" : "#999", marginRight: "5px" }} />
                  ) : (
                    <Icon.Plus style={{ color: hovered ? "black" : "#999", marginRight: "5px" }} />
                  )}
                </div>
              </Button>
            </div>
                ...
                <div className="mb-3">
                  ...
                  {Object.keys(data.setupParam.possibleSettings).map((key) => (
                      <div className="row mb-2">
                        ...
                        <OverlayTrigger
                            placement="top"
                            overlay={<Tooltip id="tooltip">{Array.isArray(data.setupParam.possibleSettings[key].default_val) ?
                              updatedSettings[key].default_val :
                              updatedSettings[key].default_val}</Tooltip>}
                          >
                            <p
                              className="fw-bold mb-0"
                              style={{ whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}
                            >
                              {Array.isArray(data.setupParam.possibleSettings[key].default_val) ?
                                updatedSettings[key].default_val.join(", ") :
                                updatedSettings[key].default_val}
                            </p>
                          </OverlayTrigger>
