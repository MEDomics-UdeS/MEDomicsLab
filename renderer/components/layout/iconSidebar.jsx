...
const IconSidebar = ({ onSidebarItemSelect }) => {
  ...
  const { layoutState, dispatchLayout, developerMode, setDeveloperMode } =
    useContext(LayoutModelContext)
    ...
    <>
      <div className="icon-sidebar">
        ...
        <Tooltip
          ...
          {...delayOptions}
          className="tooltip-icon-sidebar"
          data-pr-disabled={!showTooltip}
        />
        <Tooltip
          target=".extraction-speeddial .p-speeddial-action"
          {...delayOptions}
          className="tooltip-icon-sidebar"
        />
        <Tooltip
          target=".exploratoryNav"
          {...delayOptions}
          className="tooltip-icon-sidebar"
        />
        <Tooltip
        ...
        >
          <Nav.Link
            ...
            onAuxClick={(event) => handleRightClick(event, "Home")}
          >
            <HouseFill
              size={"1.25rem"}
              width={"100%"}
          ...
          <div className="medomics-layer design">
            <div className="sidebar-icons">
              <Nav.Link
                ...
                onAuxClick={(event) => handleRightClick(event, "Input")}
              ...
              <div
                ...
                data-pr-disabled={!showTooltip}
                data-tooltip-id="tooltip-extracction"
              >
                <SpeedDial
              ...
              <Nav.Link
                ...
                onAuxClick={(event) => handleRightClick(event, "Exploratory")}
          ...
          <div className="medomics-layer development ">
            <div className="sidebar-icons">
              ...
              >
                <LuNetwork
                  style={{ height: "1.7rem", width: "auto", rotate: "-90deg" }}
                />
              </Nav.Link>

              <Nav.Link
                className="resultsNav btnSidebar align-center"
                data-pr-at="right center"
                data-pr-my="left center"
                ...
                disabled={disabledIcon}
                onAuxClick={(event) => handleRightClick(event, "Results")}
              >
              ...
              <Nav.Link
                ...
                disabled={disabledIcon}
                onAuxClick={(event) => handleRightClick(event, "Evaluation")}
              >
          ...
          <div className="medomics-layer deployment">
            <div className="sidebar-icons">
              <Nav.Link
                ...
                disabled={disabledIcon}
                onAuxClick={(event) => handleRightClick(event, "Application")}
              >
                <Send
                  size={"1.25rem"}
                  width={"100%"}
          ...
          <div
            className="d-flex icon-sidebar-divider"
            style={{ flexGrow: "1" }}
          ></div>
          ...
          >
            <NavDropdown.Item
              ...
              href="#/action-1"
              onClick={(event) => handleToggleDeveloperMode(event)}
            >
