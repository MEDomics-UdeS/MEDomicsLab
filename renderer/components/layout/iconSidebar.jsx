  ...
  return (
    <>
      <div className="icon-sidebar">
        ...
        <Tooltip target=".DataManager-btn" {...delayOptions} className="tooltip-icon-sidebar" />
        <Tooltip target=".MLMEDimg-btn" {...delayOptions} className="tooltip-icon-sidebar" />
        <Tooltip target=".BatchExtractor-btn" {...delayOptions} className="tooltip-icon-sidebar" />
        <Tooltip target=".ext-MEDimg-btn" {...delayOptions} className="tooltip-icon-sidebar" />
        {/* ------------------------------------------- END Tooltips ----------------------------------------- */}
