...
const SidebarFile = (props) => { // This component is used to render a file in the sidebar
	...
	let plusIcon = <button className="sidebar-file-button" onClick={(e) => OnClickAdd(e, props.name)} ><PlusSquare /></button>; // We define the plus icon
	let deleteIcon = <button className="sidebar-file-button" onClick={(e) => OnClickDelete(e, props.name)} ><XSquare /></button>; // We define the delete icon
	let before = <></>;
	let after = <></>;
