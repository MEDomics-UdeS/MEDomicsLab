...
export function TabStorage({ tab, layout }: { tab: TabNode; layout: Layout }) {
  ...
  return (
    <div ref={setContents} className="tab-storage">
      <p>This component demonstrates the custom drag and drop features of FlexLayout, by allowing you to store tabs in a list. You can drag tabs into the list, reorder the list, and drag tabs out of the list, all using the layout's built-in drag system!</p>
