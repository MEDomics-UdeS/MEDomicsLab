  ...
  useEffect(() => {
    ...
    if (Object.keys(props).length == 0) {
      ...
      if (props.keepOnlyFolder != undefined) {
        ...
        newWorkspaceTree.workingDirectory.children =
          newWorkspaceTree.workingDirectory.children.filter((child) => {
      ...
      <>
        {workspaceTree.workingDirectory["name"] &&
          SidebarFolder({
            ...
            name: workspaceTree.workingDirectory["name"],
            children: workspaceTree.workingDirectory["children"]
          })}
      </>
    )
  }
