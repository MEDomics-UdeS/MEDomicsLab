...
const SidebarFolder = (props) => {
  // This component is used to render a folder in the sidebar
          ...
          <Stack className="sidebar-folder-stack" direction="vertical" gap={0}>
            {props.children.map((child) => {
              if (child.children !== undefined) {
                ...
                return <SidebarFile name={child.name} key={randomUUID()} />
              }
            })}
          </Stack>
        </Accordion.Body>
...
const SidebarFile = (props) => {
  ...
  } // This function is used to handle the click on the add button
  function OnClickDelete(e, name) {
    dispatchLayout({
      type: "remove",
      payload: { type: "tab", name: name, component: "grid" }
    })
  } // This function is used to handle the click on the delete button
