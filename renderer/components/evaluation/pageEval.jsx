      ...
      requestBackend(
        ...
        (data) => {
          ...
          requestBackend(
            ...
            { pageId: pageId, model: config.model, dataset: config.dataset, sampleSizeFrac: 0.01, dashboardName: config.model.name.split(".")[0], modelObjPath: modelObjCopies.dashboard },
            (data) => {
