...
const InputForm = ({ nodeForm, changeNodeForm, enableView }) => {
   ...
   *
   * @description
   * This function is used to send a POST request to /extraction_img/upload when the user
  ...
  const handleUpload = useCallback(
    (fileType) => {
      ...
      if (selectedFile && selectedFile !== "") {
        ...
        // POST request to /extraction_img/upload for current node by sending form data of node
        requestJson(port, "/extraction_img/upload", formData, (response) => {
          if (response.error) {
