...
const TransformColumnTools = ({ fileName, setFileName, selectedColumns, setSelectedColumns, columns, transformData, handleFileUpload, handleExportColumns, handleDeleteColumns }) => {
    ...
    return (
      ...
      />
                ...
                <input id="fileUpload"
                       type="file"
                       accept=".csv" onChange={handleFileUploadUpdated}
                       style={{display: "none"}}/>
            </div>
        </>
    )
