...
const classificationSettings = {
	...
	"clean": {
		"options": {
			...
			"fix_imbalance": {
				"type": "bool",
				"tooltip": "<p><p>When training dataset has unequal distribution of target class it can be balanced\nusing this parameter. When set to True, SMOTE (Synthetic Minority Over-sampling\nTechnique) is applied by default to create synthetic datapoints for minority class.</p>\n</p>",
				"default_val": "False"
			},
			"fix_imbalance_method": {
				"type": "imblearn estimator",
				"tooltip": "<p><p>When fix_imbalance is True, <cite>imblearn</cite> compatible estimator with a\n<cite>fit_resample</cite> method can be passed. If None, <cite>imblearn.over_sampling.SMOTE</cite>\nis used.</p>\n</p>",
				"default_val": "None"
			}
		},
	...
	"create_model": {
		"options": {
			...
			"engine": {
				...
				"tooltip": "<p><p>The execution engine to use for the model, e.g. for Logistic Regression (\u201clr\u201d), users can\nswitch between \u201csklearn\u201d and \u201csklearnex\u201d by specifying\n<cite>engine=\u201dsklearnex\u201d</cite>.</p>\n</p>",
				"default_val": ""
			},
			"verbose": {
				"type": "bool",
	...
	"deploy": {
		"predict_model": {
			"options": {
				...
				"encoded_labels": {
					"type": "bool",
					"tooltip": "<p><p>When set to True, will return labels encoded as an integer.</p>\n</p>",
					"default_val": "False"
				},
				"raw_score": {
					"type": "bool",
					"tooltip": "<p><p>When set to True, scores for all labels will be returned.</p>\n</p>",
					"default_val": "False"
				},
				"drift_report": {
					"type": "bool",
			...
			"default": {
				"data": {
					...
					"tooltip": "<p><p>Shape (n_samples, n_features). All features used during training\nmust be available in the unseen dataset.</p>\n</p>"
				}
			}
		},
		"finalize_model": {
	...
	"stack_models": {
		"options": {
			"meta_model": {
				"type": "list",
				"tooltip": "<p><p>When None, Logistic Regression is trained as a meta model.</p>\n</p>",
				"default_val": "None",
				"choices": {
					"lr": "Logistic Regression",
					"knn": "K Neighbors Classifier",
	...
	"calibrate_model": {
		"options": {
			"method": {
				"type": "string",
				"tooltip": "<p><p>The method to use for calibration. Can be \u2018sigmoid\u2019 which corresponds to\nPlatt\u2019s method or \u2018isotonic\u2019 which is a non-parametric approach.</p>\n</p>",
				"default_val": "sigmoid"
			},
			"calibrate_fold": {
				"type": "integer or scikit-learn compatible CV generator",
